...
const useStyles = makeStyles({
  gradientBackground: {
    background: "linear-gradient(135deg, #fde7f3 0%, #ffffff 45%, #f0f9ff 100%)",
    minHeight: "100vh",
    position: "relative",
    overflow: "hidden",
  },
  ...
  infoCard: {
    ...
    "&:hover": {
      ...
      boxShadow: "0 16px 40px rgba(255, 138, 101, 0.2)",
...
const SocialCommittee = () => {
  ...
  const committeeInfo = [
    {
      icon: <GroupsIcon className={classes.infoIcon} />,
      title: "Community Building",
      desc: "Fostering strong bonds between students and communities through meaningful engagement.",
    },
    {
      icon: <HandshakeIcon className={classes.infoIcon} />,
      title: "Social Impact",
      desc: "Creating tangible change in society through organized social welfare programs.",
    },
    {
      icon: <EmojiPeopleIcon className={classes.infoIcon} />,
      title: "Volunteer Support",
      desc: "Empowering volunteers with training and resources for effective service delivery.",
    },
    {
      icon: <VolunteerActivismIcon className={classes.infoIcon} />,
      title: "Inclusive Outreach",
      desc: "Ensuring every voice is heard through diverse and accessible community programs.",
    },
  ];
  ...
  const roles = [
    ...
    },
    {
      ...
      desc:
        "Partners with NGOs and government bodies to execute sustainable social projects and maximize outreach.",
      img1: heroImages[2],
      img2: heroImages[0],
    },
    {
          ...
          <motion.div className={classes.heroSection}
            ...
            <motion.div
              ...
              <Typography className={classes.subtitleText}>
                Building Bridges Between Communities | Creating Lasting Impact | Empowering Change
              </Typography>
            </motion.div>
          </motion.div>
