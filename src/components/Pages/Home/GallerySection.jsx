  ...
  return (
    <Box
      sx={{
        ...
        // ✅ ADD SPACING AROUND THIS SECTION
        mt: { xs: 20, md: 10 },   // space above
        mb: { xs: 6, md: 10 },   // space below
        px: { xs: 2, md: 0 },    // side padding for mobile

        // existing padding inside the section
