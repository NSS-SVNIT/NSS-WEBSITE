    ...
    <div style={{ overflowX: 'hidden' }}>
      <Grid container spacing={2} sx={{ marginTop: '45px', marginLeft: '60px', marginBottom: '60px' }}>
        ...
        <Grid item xs={6} sm={6} md={6}>
          ...
          <img src="https://firebasestorage.googleapis.com/v0/b/nss-svnit.appspot.com/o/team%20page%2Fteam.jpg?alt=media&token=250a96b8-c607-44f3-a1c7-d10c7072c89f" alt="Right Content" height="500px" />
          </Slide>
        </Grid>
      </Grid>
    </div>
