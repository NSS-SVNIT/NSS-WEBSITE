  ...
  return (
    <Card
      sx={{
        ...
        height: isMobile?"30vh":props.type==='Camp Report'?'30vh':"25vh",
    ...
    >
      <Box sx={{ display: "flex", flexDirection: "column" }}>
        <CardContent
          sx={{ flex: "1 0 auto" }}
          style={{ boxSizing: "border-box", heigth: "100%", width: isMobile?"50vw":"20vw" }}
        >
          <Typography className="name" component="div" variant={isMobile&&props.type==='Camp Report'?"":"h5"} textAlign={"center"}>
            {props.name}
          </Typography>
          <Typography
            variant="subtitle1"
          ...
          >
            <button className="button" type="button">
              <span className="button__text">E-Book</span>
              <span className="button__icon">
