...
const About = () => {
  ...
  return (
      <Layout>
        ...
        <Box>
          <motion.div >
            <Typography variant='h6' sx={{
              m: "23px", p: "25px", textAlign: "justify", bgcolor: "#ffebff", borderRadius: "25px",
              display: "flex",
              justifyContent: "center",
              alignItems: "center",
              rows: "10",
              overflowX: 'hidden'
            }} >NSS Unit SVNIT has been trying to realise its aim of bringing the community along with it to prosperity in a rising India.
        ...
        <Typography variant='h2' sx={{ px: 10, pt: 5, fontWeight: 400, overflowX: 'hidden' }}>ABOUT NSS INDIA</Typography>
        <br />
        <Box>
          <motion.div >
            <Typography variant='h6' sx={{
        ...
        <div style={{ overflowX: 'hidden' }}>
          <Grid container spacing={2} sx={{ marginTop: '45px', marginLeft: '60px', marginBottom: '60px', overflowX: 'hidden' }}>
            ...
            <Grid item xs={12} sm={6} md={7} sx={{ overflowX: 'hidden', width: { lg: "100%", md: "50%", sm: "40%", xs: "20%" }, height: { lg: "100%", md: "50%", sm: "40%" } }}>
              <motion.div style={{ overflowX: 'hidden', position: 'relative', width: '100%', height: '600px', paddingTop: '100%', backgroundColor: '#ffebff', borderRadius: '50%' }}
                initial={{ opacity: 0, x: 50 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 2 }}>
                <motion.img src={url} alt="Right Content" height="80%" style={{ overflowX: 'hidden', position: 'absolute', top: 90, left: 90, right: 90, bottom: 90, width: '80%', objectFit: 'cover', borderRadius: '50%' }}
        ...
        <Grid container spacing={1} sx={{ overflowX: 'hidden', display: "flex" }}>
        ...
        <div style={{ overflowX: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
